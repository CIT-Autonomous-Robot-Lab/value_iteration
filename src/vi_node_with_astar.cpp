#include "value_iteration/vi_node_with_astar.h"
...
ViNode::ViNode() : private_nh_("~"), yaw_(0.0), x_(0.0), y_(0.0), online_("false")
{
    ...
    vi_.reset(new Astar_ValueIterator(*actions_, thread_num));
...
void ViNode::setCommunication(void)
{
    ...
    pub_astar_value_function_= nh_.advertise<nav_msgs::OccupancyGrid>("astar_value_function", 2, true);
